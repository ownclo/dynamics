...
set title "Perpendicularly positioned vibrator (Y axis)"
...
plot "./data"\
				ind 5 u 1:3 w p pt 7 ps 1 lc rgb "blue" notitle,\
			 "" ind 5 u 1:3:(r) title "{/Symbol f} = 30" ls 1 s acs,\
			 ""	ind 6 u 1:3 w p pt 7 ps 1 lc rgb "red" notitle,\
			 "" ind 6 u 1:3:(r) title "{/Symbol f} = 60" ls 2 s acs
