...
set title "Parallel position of vibrator (Z axis)"
...
plot "./data"\
				ind 3 u 1:3 w p pt 7 ps 1 lc rgb "blue" notitle,\
			 "" ind 3 u 1:3:(r) title "{/Symbol f} = 30" ls 1 s acs,\
			 ""	ind 4 u 1:3 w p pt 7 ps 1 lc rgb "red" notitle,\
			 "" ind 4 u 1:3:(r) title "{/Symbol f} = 60" ls 2 s acs
